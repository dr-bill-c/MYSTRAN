...
MODULE MKL_DFTI
  ...
  INTERFACE DftiComputeForward
     ...
     FUNCTION dfti_compute_forward_ss(desc,sSrcDstRe,sSrcDstIm)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: sSrcDstRe
       REAL(DFTI_SPKP), INTENT(INOUT), DIMENSION(*) :: sSrcDstIm
     ...
     FUNCTION dfti_compute_forward_dd(desc,dSrcDstRe,dSrcDstIm)
       ...
       TYPE(DFTI_DESCRIPTOR), POINTER :: desc
       REAL(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: dSrcDstRe
       REAL(DFTI_DPKP), INTENT(INOUT), DIMENSION(*) :: dSrcDstIm
